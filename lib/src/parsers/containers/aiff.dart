...
class AiffParser extends TagParser<RiffMetadata> {
  ...
  /// Embedded ID3 metadata, merged after scanning the whole AIFF file so it
  /// can override earlier NAME/AUTH/ANNO values when both are present.
  Mp3Metadata? _embeddedId3Metadata;
  ...
  RiffMetadata parse(RandomAccessFile reader) {
    ...
    if (_embeddedId3Metadata != null) {
      _mergeId3Metadata(_embeddedId3Metadata!);
    }
